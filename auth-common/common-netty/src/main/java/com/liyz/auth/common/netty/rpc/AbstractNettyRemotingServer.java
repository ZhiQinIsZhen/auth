...
public abstract class AbstractNettyRemotingServer extends AbstractNettyRemoting implements RemotingServer{
    ...
    public AbstractNettyRemotingServer(ThreadPoolExecutor messageExecutor, NettyServerProperties nettyServerProperties) {
        super(messageExecutor);
        serverBootstrap = new NettyServerBootstrap(nettyServerProperties);
    ...
    public Object sendSyncRequest(String resourceId, String clientId, Object msg) throws TimeoutException {
        ...
        return super.sendSync(channel, rpcMessage, serverBootstrap.getNettyServerConfig().getRpcRequestTimeout());
    }
