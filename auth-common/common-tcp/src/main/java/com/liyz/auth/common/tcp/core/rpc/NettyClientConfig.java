...
public class NettyClientConfig extends NettyBaseConfig {
    ...
    //todo
    private static final boolean ENABLE_CLIENT_BATCH_SEND_REQUEST = DEFAULT_ENABLE_CLIENT_BATCH_SEND_REQUEST;

    public NettyClientConfig(TransportProperties transportProperties) {
    ...
    public int getClientSelectorThreadSize() {
        return transportProperties.getThreadFactory().getClientSelectorThreadSize() == 0
                ? DEFAULT_SELECTOR_THREAD_SIZE : transportProperties.getThreadFactory().getClientSelectorThreadSize();
    }
    ...
    public String getClientSelectorThreadPrefix() {
        return StringUtils.isBlank(transportProperties.getThreadFactory().getClientSelectorThreadPrefix())
                ? DEFAULT_SELECTOR_THREAD_PREFIX : transportProperties.getThreadFactory().getClientSelectorThreadPrefix();
    }
    ...
    public String getClientWorkerThreadPrefix() {
        return StringUtils.isBlank(transportProperties.getThreadFactory().getClientWorkerThreadPrefix())
                ? DEFAULT_WORKER_THREAD_PREFIX : transportProperties.getThreadFactory().getClientWorkerThreadPrefix();
    }
