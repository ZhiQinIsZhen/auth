package com.liyz.auth.common.tcp.loader;
...
public class EnhancedServiceLoader {
     ...
     */
    public static <S> S load(Class<S> service, ClassLoader loader) throws RemoteServiceException {
     ...
     * @throws RemoteServiceException
     */
    public static <S> S load(Class<S> service) throws RemoteServiceException {
     ...
     * @throws RemoteServiceException
     */
    public static <S> S load(Class<S> service, String activateName) throws RemoteServiceException {
     ...
     * @return s s
     * @throws RemoteServiceException the enhanced service not found exception
     */
    ...
    private static class InnerEnhancedServiceLoader<S> {
        ...
        private static final String LIYZ_DIRECTORY = "META-INF/liyz/";
         ...
         * @throws RemoteServiceException
         */
        private S load(ClassLoader loader) throws RemoteServiceException {
        ...
        private List<S> loadAll(Class[] argsType, Object[] args, ClassLoader loader) {
            ...
            try {
                ...
                throw new RemoteServiceException("exception", t);
            }
            return allInstances;
        }
            ...
            try {
                ...
                if (e instanceof RemoteServiceException) {
                    ...
                    throw new RemoteServiceException(
                            "not found service provider for : " + type.getName() + " caused by " + e);
                }
            }
        }
        ...
        private S getExtensionInstance(ExtensionDefinition definition, ClassLoader loader, Class[] argTypes,
                                       Object[] args) {
            if (definition == null) {
                throw new RemoteServiceException("not found service provider for : " + type.getName());
            }
        ...
        private List<ExtensionDefinition> findAllExtensionDefinition(ClassLoader loader) {
            ...
            try {
                ...
                loadFile(LIYZ_DIRECTORY, loader, extensionDefinitions);
            } catch (IOException e) {
                throw new RemoteServiceException("io", e);
            }
